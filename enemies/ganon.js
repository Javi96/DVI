    ...
    Q.Sprite.extend('Ganon', {
        ...
        kicked: function(){        
            if(!this.p.hideousLaughter){
                ...
                this.p.y=100;
                this.stage.insert(new Q.Deadrock({id_enemy: 10,x:150,y:250}));
                this.stage.insert(new Q.Soldier({id_enemy: 11,x:200,y:180}));
                this.stage.insert(new Q.Soldier({id_enemy: 12,x:280,y:180}));
                this.stage.insert(new Q.Deadrock({id_enemy: 13,x:325,y:250}));
                this.stage.insert(new Q.Deadrock({id_enemy: 14,x:150,y:400}));
                this.stage.insert(new Q.Deadrock({id_enemy: 15,x:325,y:400}));
                fire = Q('fire')
                for(f of fire.items){
                    f.destroy();
                }
