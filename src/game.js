window.addEventListener('load', function() {
    ...
    var link = 'link.png, link.json, loading.sword3.png, loading.sword3.json, sword.sword3.png, sword.sword3.json, dying.png, dying.json, sword.tunic1.png, sword.tunic1.json';
