function loadLink(Q){
    ...
    Q.animations("linkAnim", {
		...
		"walking_down_right": { frames: [52,53,54], rate: 1/12, next: 'stand_down_right' },
		"walking_down_left": { frames: [41,42,43], rate: 1/12, next: 'stand_down_left' },
		"stand_down": { frames: [44] },
		"stand_down_right": { frames: [52] },
		"stand_down_left": { frames: [41] },
